...
/***/ "../node_modules/css-loader/dist/cjs.js?!../node_modules/postcss-loader/src/index.js?!../node_modules/sass-loader/dist/cjs.js!./style/index.css":
/*!***************************************************************************************************************************************************************!*\
  !*** ../node_modules/css-loader/dist/cjs.js??ref--8-1!../node_modules/postcss-loader/src??ref--8-2!../node_modules/sass-loader/dist/cjs.js!./style/index.css ***!
  \***************************************************************************************************************************************************************/
...
/* harmony import */ var _constants_stores__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./constants/stores */ "./constants/stores.ts");
...
function (_super) {
  ...
  function MainPanel() {
    ...
    _this.handleFloorChange = function (e) {
    ...
    _this.handleSelectStore = function (e) {
      _this.setState(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, _this.state), {
        currentStore: e.target.value
      }));
    };

    _this.handleAddStore = function (e) {
      var _a = _this.state,
          currentStore = _a.currentStore,
          currentListStore = _a.currentListStore;
      if (currentStore !== 'None' && !currentListStore.includes(currentStore)) _this.setState({
        currentListStore: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(currentListStore, [currentStore])
      });
    };

    _this.handleAddCustomStore = function () {
      var _a = _this.state,
          customStore = _a.customStore,
          currentListStore = _a.currentListStore;
      ...
      if (customStore != '' && !currentListStore.includes(customStore)) {
        _this.setState(function (prevState) {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, prevState), {
            customStore: '',
            currentListStore: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"])(currentListStore, [customStore])
          });
        });
      }
    };
    ...
    _this.handleReset = function (e) {
      _this.setState(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, initialState));
    };

    _this.addDataRecord = function (store) {
      return function () {
        var record = {
    ...
    _this.handleInputField = function (e) {
      _this.setState({
        fileName: e.target.value
      });
    };

    _this.handleInputCustomStore = function (e) {
      _this.setState({
        customStore: e.target.value
      });
    };
  ...
  MainPanel.prototype.render = function () {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      ...
      onChange: this.handleInputCustomStore,
      value: customStore
    }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("button", {
      className: "btn btn-primary",
      onClick: this.handleAddCustomStore
    }, "Add Store")), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
      ...
      value: fileName
    }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_csv__WEBPACK_IMPORTED_MODULE_2__["CSVLink"], {
...
var eg_stores = ['BOX', 'Favors! by cbr', 'Parfümerie Akzente', 'Tally Weijl', 'Toni Tänzer Platform', 'REWE', 'Sparkasse', 'Schlüsseldienst Phonerep', 'Bruzzes Weinwelt', 'Kinderbetreuung', 'Quickschuh', 'Penny', 'Kamps', 'Woll-Studio', 'Takko Fashion', 'Trendstore', 'Setzer', 'Alona Schmuck', 'Optikwelt', 'Telekom Shop', 'Grabert', 'Cafe im Ö'];
var ug_stores = ['Modehaus Bär', 'Injoy', 'Intersport Grabert', 'Shoetown Werdich', 'Brautmoden Fabian', 'Haucks Schnitzelwelt', 'Vielseitig Bücher', 'Team 5'];
...
var api = __webpack_require__(/*! ../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
            var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js??ref--8-1!../../node_modules/postcss-loader/src??ref--8-2!../../node_modules/sass-loader/dist/cjs.js!./index.css */ "../node_modules/css-loader/dist/cjs.js?!../node_modules/postcss-loader/src/index.js?!../node_modules/sass-loader/dist/cjs.js!./style/index.css");
